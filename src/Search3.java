...
/**
 * To be able to run, three command-line arguments are required.
...
public class Search3 {
    ...
    public static void main(String[] args) {
        try {
            ...
            Logger.getLogger(Search1.class.getName()).severe("java Search3 <algorithm> <heuristic_method> <map_no>");
        }
    }
